...
;; Copyright (C) 2022-2023 Phong Le
;; This file is licensed under MIT license. See <https://github.com/phonglenus/dotfiles>
...
(setq doom-font (font-spec :family "CaskaydiaCove Nerd Font" :size 14) ; `describe-font', `eval-region', `doom/reload-font'
      doom-variable-pitch-font (font-spec :family "CaskaydiaCove Nerd Font" :size 14)) ; non-monospace font
